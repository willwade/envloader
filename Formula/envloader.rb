class Envloader < Formula
  ...
  if OS.mac?
    if Hardware::CPU.arm?
      url "https://github.com/willwade/envloader/releases/download/v0.1.3/envloader_Darwin_arm64.tar.gz"
      sha256 "853854d90a42cfebb0f26ffdcf3ed6ec3b86bb65415c5b1a39f1f6705e5c7bc3"
    else
      url "https://github.com/willwade/envloader/releases/download/v0.1.3/envloader_Darwin_x86_64.tar.gz"
